...
fn process_file(path: &Path, out_dir: &Path) -> Result<Vec<pattern_detector::PatternInfo>> {
    ...
    // 2) Pretty-print and write the modified file to out/ en caso de ser necesario tenerlos a mano
    ...
    // 4) Detect patterns using pattern_detector and return patterns
