...
In the file: <a onclick="cargarArchivo('st/src/abb.rs','unsafe_src/abb_18','82')"><em>abb.rs</em></a> linea 82 columna 12
<code class="rust" style="border-radius: 10px;">
unsafe { std :: alloc :: dealloc (nodo as * mut u8 , std :: alloc :: Layout :: new :: &lt; Nodo &gt; ()) ; }</code>
<code class="rust" id="unsafe_src/abb_18" style="overflow: auto; height: 150px; display: none;"></code>
